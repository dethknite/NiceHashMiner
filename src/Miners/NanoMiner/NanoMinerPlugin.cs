...
namespace NanoMiner
{
    public partial class NanoMinerPlugin : PluginBase, IDevicesCrossReference, IDriverIsMinimumRecommended, IDriverIsMinimumRequired
    {
        public NanoMinerPlugin()
        {
            ...
            {
                BinVersion = "v3.9.3",
                ExePath = new List<string> { "nanominer-windows-3.9.3", "nanominer.exe" },
                Urls = new List<string>
                {
                    "https://github.com/nanopool/nanominer/releases/download/v3.9.3/nanominer-windows-3.9.3.zip", // original
                }
            };
